...
import EditarAnun from './EditarAnuncio';
import Api from '../../Api';
...
export default ({Dados, setDados, Loading,  setLoading,  Alert, setAlert, AlertTipo,
   setAlertTipo, Avisando, setAvisando}) => {
      ...
      const [Titulo, setTitulo] = useState(" Anuncios");
       ...
       useEffect(() => {
        Listando();
          ...
          const ListApp = async ()=>{
            if (navigator.onLine) {
             setCarreg(true);
              await Api.ListAnuncio(Dados, setQuant, setUsuariosContServ);
                            ...
                            {Lista.map((item, key)=>(
                                ...
                                :
                                      ...
                                      { Carreg === true ?
                                        ...
                                        />
                                        :                                      
                                      <p style={{color:"red", margin:"20px"}}>Não existe Anuncio Cadastrado</p>
                                      }
                                      </>
                            }
